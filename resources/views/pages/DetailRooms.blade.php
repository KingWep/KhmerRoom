                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-4">
                    @php
                        ...
                        if (is_string($accessories)) {
                            ...
                            $accessories = json_last_error() === JSON_ERROR_NONE && is_array($decoded)
                                ? $decoded
                                : array_filter(array_map('trim', explode(',', $accessories)));
                        }
                    ...
                    @if(!empty($accessories))
                        @foreach($accessories as $item)
                            @php $itemKey = trim((string) $item); @endphp
